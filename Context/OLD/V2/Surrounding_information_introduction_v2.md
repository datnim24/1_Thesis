...
## Thesis: Reactive Batch Roasting Scheduling Under Unplanned Stoppages — A Comparative Study of CP-SAT Re-optimization and Reinforcement Learning at Nestlé Trị An
...
| **Working title** | **Reactive Batch Roasting Scheduling Under Unplanned Stoppages: A Comparative Study of CP-SAT Re-optimization and Reinforcement Learning at Nestlé Trị An** |

> **Title rationale:** The title names four differentiating elements: (1) "Reactive Batch Roasting Scheduling" — the focus is on responding to disruptions, not just generating a static schedule, (2) "Unplanned Stoppages" — the stochastic element that drives the thesis, (3) "Comparative Study of CP-SAT Re-optimization and Reinforcement Learning" — two fundamentally different approaches (optimization-based vs. learning-based), and (4) "Nestlé Trị An" — grounded as an industrial case study. A dispatching heuristic baseline is also compared but not named in the title (it's the control, not a primary method).
