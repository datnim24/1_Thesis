"""Pure CP-SAT solver — combined data loader, MILP model builder, and solver.

Single file consolidating CPSAT_Pure/{data.py, model.py, solver.py} into one module.
Public API: `load(input_dir, overrides)`, `build(d)`, `solve(d, model, cp_vars, num_workers)`.
"""
